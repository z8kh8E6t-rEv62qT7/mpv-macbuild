...
export VCPKG_BINARY_SOURCES="clear;files,$vcpkg_binary_cache,readwrite;nugetconfig,$nuget_config_path,$nuget_cache_mode;nugettimeout,300"
export MACOSX_DEPLOYMENT_TARGET="$macosx_deployment_target"
export CMAKE_OSX_DEPLOYMENT_TARGET="$macosx_deployment_target"
export MPV_RUSTC_DEPLOYMENT_TARGET="$macosx_deployment_target"
...

{
  ...
  echo "MPV_RUSTC_DEPLOYMENT_TARGET=$MPV_RUSTC_DEPLOYMENT_TARGET"
