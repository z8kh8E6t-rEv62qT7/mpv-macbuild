...
foreach(pkgconfig_file IN ITEMS
    "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/uchardet.pc"
    "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/uchardet.pc"
)
    if(NOT EXISTS "${pkgconfig_file}")
        message(FATAL_ERROR "Expected uchardet pkg-config file is missing: ${pkgconfig_file}")
    endif()
    ...
    if(stdlib_position EQUAL -1)
        message(FATAL_ERROR "Expected uchardet pkg-config file to reference libstdc++: ${pkgconfig_file}")
    endif()
